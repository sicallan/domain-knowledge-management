...
| [0004](./0004-ui-framework.md) | UI framework for the Knowledge Studio (React recommended) | Proposed (draft) |
| [0005](./0005-graph-visualisation-library.md) | Graph visualisation library (Cytoscape.js recommended) | Proposed (draft) |
| [0006](./0006-graphql-server-framework.md) | GraphQL server framework (GraphQL Yoga + Pothos recommended) | Proposed (draft) |
| [0007](./0007-component-library.md) | Component library / design system (shadcn/ui + Radix + Tailwind recommended) | Proposed (draft) |
